declare namespace Mcs.WebConstants {
    const committeeFullName;
    const committeeId: string;
    const webUrl: string;
    const webTitle: string;
    ...
    const lmsServiceBase: string;
    const icsServiceBase: string;
    const clientId: string;
    const tenantId: string;
    const currentLmsUrl: string;
}